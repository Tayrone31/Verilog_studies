...
REM
REM Generated by Vivado on Wed Nov 09 15:06:29 +0300 2022
...
echo "xvlog --incr --relax -prj tb_soru_2_vlog.prj"
call xvlog  --incr --relax -prj tb_soru_2_vlog.prj -log xvlog.log
