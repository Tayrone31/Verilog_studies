...
REM
REM Generated by Vivado on Tue Nov 08 23:34:30 +0300 2022
...
echo "xvlog --incr --relax -prj tb_soru1a_vlog.prj"
call xvlog  --incr --relax -prj tb_soru1a_vlog.prj -log xvlog.log
