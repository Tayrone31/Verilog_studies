...
REM
REM Generated by Vivado on Thu Nov 10 14:58:42 +0300 2022
...
echo "xvlog --incr --relax -prj tb_araba_engel_vlog.prj"
call xvlog  --incr --relax -prj tb_araba_engel_vlog.prj -log xvlog.log
